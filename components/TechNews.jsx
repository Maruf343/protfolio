...
export default function TechNews() {
  ...
  useEffect(() => {
    fetchNews();
    const interval = setInterval(fetchNews, Number(process.env.NEXT_PUBLIC_NEWS_POLL_MS) || 60000);
  ...
  return (
    ...
    >
      {/* Floating particles like About Me */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article, index) => (
            <motion.div
              ...
              className="bg-white/20 dark:bg-gray-800/20 backdrop-blur-md rounded-2xl shadow-xl overflow-hidden flex flex-col border border-indigo-300/20 dark:border-indigo-500/20 hover:scale-105 transition-transform duration-300"
            >
              {article.urlToImage && (
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <a
                  ...
                  className="mt-auto inline-block px-4 py-2 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-lg font-medium shadow hover:from-indigo-600 hover:to-indigo-700 transition"
                >
                  Read More
                </a>
              </div>
